...
!(function (n) {
    ...
    n(document).ready(function () {
        ...
        if (
            ...
            n(".header__menu>ul>li .arrow").click(function () {
                n(this).parent().hasClass("active") ? n(this).parent().removeClass("active") : (n(this).parent().siblings().removeClass("active"), n(this).parent().addClass("active"));
            }),
            t(),
